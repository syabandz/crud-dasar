         ...
         <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <i class="fa fa-book fa-fw"></i>&nbsp;&nbsp;Table Akuntansi
                  ...
                  <a href="javascript:void(0);" data-toggle="modal" data-target="#akuntansi" class="btn btn-danger"><i class="material-icons">add_circle</i><span>Tambah Data Akuntansi</span></a>
                  <div class="clearfix"></div>    
                    <div class="panel-body">
                        <table data-toggle="table" data-show-refresh="false" data-show-toggle="true" data-show-columns="true" data-search="true"  data-pagination="true" data-sort-name="name" data-sort-order="asc">
                                <thead>
         ...
         <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <i class="fa fa-book fa-fw"></i>&nbsp;&nbsp;Table Neraca
                  ...
                  <a href="template.php?pages=neraca" class="btn btn-info"><i class="material-icons">book</i><span>Data Akuntasi</span></a>
                  <a href="javascript:void(0);" data-toggle="modal" data-target="#neraca" class="btn btn-danger"><i class="material-icons">add_circle</i>
                        <span>Tambah Data Neraca</span></a>
                  <div class="clearfix"></div>    
                    <div class="panel-body">
                        <table data-toggle="table" data-show-refresh="false" data-show-toggle="true" data-show-columns="true" data-search="true"  data-pagination="true" data-sort-name="name" data-sort-order="asc">
                                <thead>
        ...
        <div class="modal-body">
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <i class="fa fa-user fa-fw"></i>FORM TAMBAH DATA USERS
                        </div>
                        <div class="panel-body">
                        <br>&nbsp;&nbsp;&nbsp;&nbsp;
                            <div align="center">
